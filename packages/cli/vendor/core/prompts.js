...
export const BRIEF_SCHEMA = {
    ...
    properties: {
        ...
        flow_distractors: {
            ...
            maxItems: 3,
            items: { type: 'string' },
            description: 'Three WRONG one-sentence flow descriptions. Each must be plausible for THIS repository and reference real files or symbols from the diff, wrong only in the direction, ordering, or responsibility of the flow. Never obviously absurd.',
        },
    },
};
